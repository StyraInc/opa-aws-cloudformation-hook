...
public class PreDeleteHookHandlerTest {
    ...
    public void handleRequest_SimpleSuccess() {
        final PreDeleteHookHandler handler = new PreDeleteHookHandler();
        ...
        final HookHandlerRequest request = HookHandlerRequest.builder()
            .hookContext(HookContext.builder().targetName("Other::Example::Resource").build())
            .build();
